    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('categorie', EntityType::class, [
                ...
                'multiple' => true,
                'attr' => [
                    'class' => "w-full bg-white py-3 px-6 text-base font-medium text-black outline-none focus:border-[#FF9029] focus:shadow-md grid grid-cols-2 gap-2",
                ]
            ])
